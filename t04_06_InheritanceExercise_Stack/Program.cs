...
namespace t04_06_InheritanceExercise_Stack
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // properly in all these edge cases.
            ...
            // 1
            //
            // Note: The downside of using the object class here is that if we store value types(eg int, char, bool, DateTime)
            // in our Stack, boxing and unboxing occurs, which comes with a small performance penalty.
